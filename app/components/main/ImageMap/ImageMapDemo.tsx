import { PolygonAnnotation, PolygonStyleProps } from "polygon-annotation";
...
export default function Index() {
  ...
  return (
    <div className="remix__page">
      {mounted ? <ImageMap /> : "Not mounted ImageMap"}
    </div>
  );
}

export function ImageMap() {
  const [maxPolygons, setMaxPolygons] = useState<number>(
