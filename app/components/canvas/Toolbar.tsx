...
import { PolygonStyleProps } from "polygon-annotation";
import { usePolygonContext } from "./lib/PolygonContext";
import "./Toolbar.css";
...
const Toolbar = ({
  ...
  const { state, undo, redo, canUndo, canRedo, updatePolygonLabel, deleteAll } =
    usePolygonContext();
